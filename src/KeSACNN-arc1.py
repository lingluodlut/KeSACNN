...
if __name__ == '__main__':
    ...
    s = {
         'max_len_token':600, # number of backprop through time steps BC3:400  BC2:600
         'max_len_abner':600,
         'max_len_cui':600,
         'hidden_dims':64,
         'block_num':3,
...
#chanel1    
    ...
    for i in range(s['block_num']-1):
        if s['self_att']==True:
            ...
            chanel2_x=mulhead_self_att(inputs=chanel2_x)
            chanel3_x=mulhead_self_att(inputs=chanel3_x)
...
#    opt = SGD(lr=0.008, decay=1e-6, momentum=0.9, nesterov=True)
    ...
    result_file='./ppiac-results/resnet-arc1-token-ner-cui-4b-100d.ppiac2_testresult'
    model_file='./ppiac-model/resnet-arc1-token-ner-cui-4b-100d.ppiac2_model'
